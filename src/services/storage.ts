...
export const INITIAL_PACKAGES: CablePackage[] = [
  ...
  // StarTimes
  {
    id: 'pkg_st_super',
    service: 'StarTimes',
    packageName: 'StarTimes Super',
    price: 8200,
    channelsCount: 90,
    description: 'Full sports lineup (Bundesliga, Europa), Bollywood and discovery.',
    status: 'active',
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z',
  },
  {
    id: 'pkg_st_classic',
    service: 'StarTimes',
    packageName: 'StarTimes Classic',
    price: 5200,
    channelsCount: 70,
    description: 'Great family entertainment, documentary and sports variety.',
    status: 'active',
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z',
  },
  {
    id: 'pkg_st_basic',
    service: 'StarTimes',
    packageName: 'StarTimes Basic',
    price: 3700,
    channelsCount: 45,
    description: 'Balanced mix of Nollywood, cartoons, music and religion.',
    status: 'active',
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z',
  },
  {
    id: 'pkg_st_nova',
    service: 'StarTimes',
    packageName: 'StarTimes Nova',
    price: 1900,
    channelsCount: 30,
    description: 'Budget-conscious bouquet with free-to-air and top local stations.',
    status: 'active',
    createdAt: '2026-01-01T00:00:00.000Z',
    updatedAt: '2026-01-01T00:00:00.000Z',
  },
